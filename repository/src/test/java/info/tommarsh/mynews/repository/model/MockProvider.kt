package info.tommarsh.mynews.repository.model
...
import info.tommarsh.mynews.repository.model.remote.*
...
object MockProvider {
    ...
    val articlesResponse =
        ArticlesResponse(listOf(articleResponse, articleResponse), "ok", 2)
